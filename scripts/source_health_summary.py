...
print(f"- Primary monitoring feeds: **{sum(1 for r in monitoring_rows if r.get('coverage_role') == 'primary_monitoring')}**")
print(f"- Monitoring fallback feeds: **{sum(1 for r in monitoring_rows if r.get('coverage_role') == 'monitoring_fallback')}**")
print(f"- Official/cross-validation feeds: **{sum(1 for r in official_rows if r.get('coverage_role') == 'cross_validation')}**")
